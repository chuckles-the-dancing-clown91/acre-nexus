...
| `maintenance` | Maintenance & Work Orders | on | `/tickets`, `/properties/{id}/tickets`, `/tickets/{id}/comments`, `/my/tickets` (resident requests + photos, see `docs/PORTAL.md`) (see `docs/RENTALS.md`) |
